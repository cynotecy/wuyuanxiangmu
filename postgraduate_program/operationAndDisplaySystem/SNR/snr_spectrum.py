...
if __name__ == '__main__':
	noise = dataGet(r"D:\myPrograms\CASTProgram\postgraduate_program\SNR\SNRspec\test_clean.txt")
	data = dataGet(r"D:\myPrograms\CASTProgram\postgraduate_program\SNR\SNRspec\test_800.txt")
