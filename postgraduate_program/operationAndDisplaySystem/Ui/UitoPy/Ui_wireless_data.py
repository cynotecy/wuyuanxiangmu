...
# Form implementation generated from reading ui file 'Ui_wireless_data.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_8.setMinimumSize(QtCore.QSize(81, 0))
        self.label_8.setMaximumSize(QtCore.QSize(81, 16777215))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.gridLayout_2.addWidget(self.label_10, 0, 3, 1, 2)
        self.lineEdit_5 = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_5.setMinimumSize(QtCore.QSize(165, 35))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "现场干扰数据IQ识别记录"))
        self.label_6.setText(_translate("Dialog", "信号名称*"))
        self.label_5.setText(_translate("Dialog", "项目名称"))
        self.label_8.setText(_translate("Dialog", "信噪比"))
        self.label_10.setText(_translate("Dialog", "采集地点"))
        self.label_14.setText(_translate("Dialog", "中心频率(MHz)*"))
        self.label_13.setText(_translate("Dialog", "带  宽(kHz)*"))
        self.label_3.setText(_translate("Dialog", "采集数据*"))
        self.label_7.setText(_translate("Dialog", "调制方式*"))
        self.pushButton_1.setText(_translate("Dialog", "..."))
        self.label_4.setText(_translate("Dialog", "识别报告"))
