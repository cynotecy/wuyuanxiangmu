...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.label.setText(_fromUtf8("天线效果比对——一体化单元二扫频（RF2->RF1）"))
    ...
    def on_pushButton_clicked_1(self):
        ...
        if self.lineEdit.text() and self.lineEdit_2.text():
            try:
                ...
                self.scan_recv = scan_thread_antenna.Recv(self.q, self.sub_socket,
                                                          path=r'D:\postgraduate_program\antenna_recv\mode1_usrp2_%s.txt')
