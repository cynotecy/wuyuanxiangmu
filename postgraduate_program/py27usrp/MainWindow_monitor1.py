...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.setWindowTitle(_fromUtf8("usrp1频谱监测"))
        self.label.setText(_translate("MainWindow", "频谱监测:本机端口6666，工程机端口5555", None))
    ...
    def on_pushButton_clicked_1(self):
        ...
        if text == _fromUtf8("开始监测"):
            ...
            self.scan_recv = scan_thread_48h.Recv(self.sub_socket, 'usrp1', RBW, path=r'D:\postgraduate_program\48recv\usrp1\%s.dat')
