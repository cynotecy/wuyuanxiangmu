...
from controller.usrp_controller.usrp_shibie.network import ResNet34
import os
...
def play(freq_point_list, file_path):
    ...
    result.append(model_test(model=model, inputs=input_data, freq_point_list=freq_point_list))
    return result
...
if __name__ == '__main__':
    ...
    result_test = play(freq_ordered_dict, "H:/single_collect_20191219124833.txt")
    print(result_test)
