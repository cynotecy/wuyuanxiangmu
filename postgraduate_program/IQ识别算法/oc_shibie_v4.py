...
def play(freq_point_list, file_path=r'..\usrp_recvfiles\auto_recognize'):

    net = ResNet34()
    logdir = r'..\python3.5\controller\usrp_controller\logs\model7.path'
    if user_cuda:
        net = net.cuda()
    ...
    for _ in os.listdir(file_path):
        ...
        result.append(model_test(model, freq_point_list, inputs=input_data, ))
        return result
