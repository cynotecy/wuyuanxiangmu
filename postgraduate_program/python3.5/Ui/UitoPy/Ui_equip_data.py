...
# Form implementation generated from reading ui file 'Ui_equip_data.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "现场干扰数据采集识别记录"))
        self.label_6.setText(_translate("Dialog", "信号名称*"))
        self.label_5.setText(_translate("Dialog", "项目名称"))
        self.label_7.setText(_translate("Dialog", "识别结果*"))
